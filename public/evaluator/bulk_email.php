<?php
session_start();
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'evaluator') { header('Location: ../login.php'); exit; }
...
if (file_exists('../../vendor/autoload.php')) {
    ...
    die('<div style="padding:20px; direction:rtl;">خطأ: ملف المكتبات غير موجود (vendor/autoload.php).</div>');
}
// ==========================================
        ...
        <div class="card-body">
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted">يمكنك استخدام {name} لذكر اسم الموظف.</small>
                </div>
