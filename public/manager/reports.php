                            ...
                            <tbody>
                                <?php foreach ($employee_reports as $emp_name => $evals): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="<?= count($evals) ?>"><small><?= htmlspecialchars($e['email']) ?></small></td>
                                        <td rowspan="<?= count($evals) ?>"><small><?= $e['dept_name'] ?? '—' ?></small></td>
                                        <?php endif; ?>
                                        <td><small>
                                        ...
                                        <td><small><?= $e['updated_at'] ? date('Y-m-d H:i', strtotime($e['updated_at'])) : '—' ?></td>
                                        <?php if ($index === 0): ?>
                                       </small> <td rowspan="<?= count($evals) ?>">
                                            <?php if ($token): ?>
